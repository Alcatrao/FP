...
def spiral_recursive(t, start, end, incr):
    if incr>0:
        if start<end:        #com while, entra num loop infinito a pintar as mesmas linhas
            t.forward(start)
            t.left(90)
            spiral_recursive(t, start+incr, end, incr)
...
def main():
    ...
    #spiral(alex, 10, 200, 10)          #original
    #spiral_recursive(alex, 10, 200, 10) #recursivo

    #spiral(alex, 200, 0, -5)
    spiral_recursive(alex, 200, 0, -5)
